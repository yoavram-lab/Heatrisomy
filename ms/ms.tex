...
However, a model without aneuploidy where the aneuploidy rate is fixed at zero, $\delta=0$, cannot explain the experimental observations~(Figure~\ref{fig:2n*-fixation}). The estimated parameter values without aneuploidy are: %% generated by MAP-and-hdi.ipynb
...
\begin{figure}[b!]
  ...
  \begin{subfigure}[t]{0.9\textwidth}
      \centering
      \includegraphics[height=1.8in]{../figures/fixation-plot-a.pdf}      
      \label{fig:fit}
    \caption{\textbf{A. Distribution.}}
  \end{subfigure}
  ...
  \begin{subfigure}[t]{0.9\textwidth}
      \centering
      \includegraphics[height=1.8in]{../figures/fixation-plot-b.pdf}      
      \label{fig:fit-cumulative}
    \caption{\textbf{B. Cumulative distribution.}}
  \end{subfigure}

  \caption{
    \textbf{Single-locus model fit with and without aneuploidy.}
    \textbf{(A)} The distribution of adaptation time (fixation of \eumt) in $10,000$ simulations of the single-locus model with aneuploidy (blue; MAP parameters) compared to two models without aneuploidy: a model with the same parameter values except $\delta=0$ (orange); and a model fitted to the data assuming $\delta=0$ (green).
...
The last bin contains all the simulations with time equal or greater than 3,000.
    \textbf{(B)}
	Cumulative distribution of the time to fixation of \eumt\ in 10,000 simulations using the MAP estimate with and without aneuploidy (i.e., $\delta=0$ is fixed).
