...
Solid black line is a linear orthogonal distance regression line (slope=$-0.559$, intercept=$0.164$).
...
\citet{Yona2012} have suggested that the aneuploid cells that come to dominate the experimental populations were later replaced by ``refined strains, which eliminated the cost associated with the trisomy, exhibit improved growth both at the permissive and the high temperatures compared with their trisomic ancestors'' and that ``it is expected that the original contribution of trisomy to heat tolerance was replaced by alternative solutions.''. 
However, our results suggest that most of the cells in the evolved euploid population do not carry mutations that were common in the aneuploid populations, but rather a different set of mutations.
Therefore, the majority of the evolved euploid cells are not descended from aneuploid cells, but rather are direct descendants of the ancestral population. 
...
% avihu: At the first stage there are more 2n cells than 2n+1 cells because of the advantage of aneuploidy under heat. Accordingly, at the seconds stage, there are more 2n+1* cells than 2n*. However, in most cases 2n*M dominate the population (and not 2n*A), because the fitness advantage of a refined mutation that emerge in 2n+1 background in hindered by the cost of aneuploidy and by the extra step needed to eliminate the extra copy of the chromosome. 

\cite{Yona2012} have analyzed the expression levels of 14 heat-shock proteins (HSP). They found that their expression level changed ``very modestly'' in the aneuploid populations, but that most of them ``showed significant up-regulation'' in the evolved euploid population. 
