...
\begin{figure}[h]
    ...
    The posterior distributions of the single-locus model parameters are roughly the same regardless of the number of simulations (4-10,000) used to approximate the likelihood.
    } 
