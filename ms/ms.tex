...
Interestingly, the genotype frequency dynamics in these simulations demonstrate that \anmt\ never reaches substantial frequency (\Cref{fig:ppc-plot}). % TODO new figure by Martin and discussion of the probability of 2n* arriving via 2n+1 - transient solution etc.
