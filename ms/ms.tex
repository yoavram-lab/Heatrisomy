...
mutation rate, $\mu=2.942\cdot10^{-6} (2.017\cdot10^{-7}-4.15\cdot10^{-6})$,
aneuploidy rate, $\delta=1.722\cdot10^{-3} (1.394\cdot10^{-3}-2.754\cdot10^{-3})$,
...
The single-locus model fits the data well: in simulations using the best-fit parameters (MAP estimate) \eumt\ fixed in 61\% of simulations by generation 1,700 and in 100\% of simulations by generation 2,350~(\cref{fig:2n*-fixation}B). % TODO IK what happened to the sentence about the fixation on anwt? green lines ub fig4?
...
mutation rate, $\mu=7.979\substack{+0.156 \\ -0.076}\cdot10^{-9}$,
...
%% generated with MAP-and-hdi.ipynb
With $\tau=10$, the estimated mutation rate was slightly lower ($\mu=1.674\cdot10^{-6}\ [2.501\cdot10^{-7}-1.741\cdot10^{-6}]$). 
With $\tau=100$, the estimated mutation rate was considerably lower ($\mu=3.81\cdot10^{-7}\ [1.508\cdot10^{-7}-4.995\cdot10^{-7}]$) and the aneuploidy rate had higher variance ($\delta=7.824\cdot10^{-4}\ [6.616\cdot10^{-4}-1.462\cdot10^{-3}]$). 
