...
\begin{figure}[h]
  ...
  \begin{subfigure}{1\textwidth}
    \centering
      ...
      \includegraphics[width=0.45\textwidth]{../figures/convergence-p3_w1.pdf}      
      \includegraphics[width=0.45\textwidth]{../figures/convergence-p4_w2.pdf}      
      \includegraphics[width=0.45\textwidth]{../figures/convergence-p5_w3.pdf}      
     \label{fig:convergence-A}
    \caption{\textbf{A. Posterior densities per iteration}}
    \end{subfigure}
    \\
    \vspace*{4mm}
  ...
  \begin{subfigure}{1\textwidth}
     ...
     \vspace*{-8mm}
    \caption{\textbf{B. ABC-SMC population properties per iteration}}
  \end{subfigure}

    \caption{
    \textbf{Single-locus model inference convergence.} 
    ABC-SMC algorithm was executed to inference single-locus model parameters. \textbf{(A)} For each parameter of the model, there's shown KDE of the posterior density of the inference per iteration.
We can see that the posterior didn't change significantly already from the first iteration. \textbf{(B)} Here are shown measures of convergence for the ABC-SMC algorithm. After iteration number 6, the acceptance threshold was $\epsilon=0.13$, the acceptance rate was $0.018$, the number of particles was 982, and the effective sample size (ESS) 651.
}
