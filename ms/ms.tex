...
p_{2n+1^*} &= 1-(1-2\mu \Delta w_{2n+1^*})^N \; \\
p_{\eumt_\delta} &=1-(1-2\delta \Delta w_{\eumt_\delta})^N.
\end{align}
\end{subequations}
Here, $\Delta w_i$ denotes the relative difference between the fitness $w_i$ of genotype $i$ and the population mean fitness, $\bar{w}$.
...
% TODO MP: p_{2n+1^*} is not defined, and why is there 1/p_{2n^*} here? shouldn't it have the waiting time for 2n+1* to appear on 2n+1 and then waiting time for 2n* to appear on 2n+1*? something is wrong here.
 T_A = \frac{1}{1-(1-p_{2n^*})(1-p_{2n+1})} + \frac{1}{p_{{2n+1^*}_\delta}} + \frac{1}{p_{2n^*}} + T_{2n \to 2n+1} + T_{2n+1 \to 2n+1^*} + T_{2n+1^* \to 2n^*} \;.
