...
\begin{figure}[b!]
  ...
  \caption{
    ...
    % TODO IK: remove k (not tau either!); also k mu is too close to the arrow right now; change alpha to delta in the figure 
  }
  \label{fig:models}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%
...
We found that for $\tau=$1, 33/32, 2, and 5 the posterior was not significantly different from the model with $\tau=1$, while for $\tau=10$ the estimated mutation rate was slightly lower, $\mu=1.654\substack{+0.879 \\ -1.775}\times10^{-6}$, and for $\tau=100$ the estimated mutation rate was significantly lower and the aneuploidy rate had higher variability. The MAP and 50\% HDI with $\tau=100$ were: %
