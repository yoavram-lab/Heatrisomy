...
\caption{
    ...
    % TODO caption should explain what each panel shows.
    ...
    \textbf{(I-M)} Fitness estimation from growth curves of \anwt\ and \eumt\ at \SI{39}{\celsius}: $\hat w_{2n*}/w_{2n+1}$=1.033 (95\% CI: 1.027 - 1.041).\\
