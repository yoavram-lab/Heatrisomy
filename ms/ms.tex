...
\hline
\emph{Fitness} $w_i$ & $1$ & $1-c+\sigma$ & $(1-c)(1+s)+\sigma$ & $1+s$               
\end{tabular}
...
\hline
\emph{Fitness} $w_i$ & $1$ & $1-c+\sigma$ & $(1-c)\prod_{j=1}^k(1+s_i)+\sigma$ & $\prod_{j=1}^k(1+s_i)$               
\end{tabular}
...
Denote by $A_{t}$ the fixation of aneuploidy at generation $t$, by $L_{t}$ the loss of aneuploidy at generation $t$, and by $L^*_{t,T}$ the loss of aneuploidy generation $t$ conditioned on no loss by generation $T$.
