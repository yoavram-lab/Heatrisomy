...
First, we tried to use additional growth curves of \eumt\; (\emph{refined} strain from \citet{Yona2012}) and \anwt\; in \SI{39}{\celsius} to estimate $w_{2n*}/w_{2n+1}$ ~(\Cref{fig:growth-curves}L). The same prior was used for $w_{2n*}/w_{2n+1*}$. This prior resulted in WAIC -57, compared to 295 with the above informative prior. % generated with WAICs.ipynb TODO IK update the WAIC with 1000 reps run for the new prior
%TODO IK: rewrite text about alternative prior, it has lower WAIC, different estimates for mutation rate etc...maybe it should be moved to results section
