...
\emph{multiple-locus model} allows for multiple mutations. Both models allow for a single aneuploid karyotype (e.g. chromosome III duplication).
...
\begin{equation} \label{eq:model} \begin{aligned}
w_{2n} & = 1 \\
w_{2n+1} & = 1-c+s_b \\
w_{2n+1*} & = (1+s)(1-c)+s_b \\
w_{2n*} & = (1+s) \;
