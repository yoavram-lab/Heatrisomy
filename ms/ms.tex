...
\begin{figure}[h!]
  ...
  \caption{
	...
	\textbf{(E)} Expected genotype frequencies (without drift) using MAP estimate parameters. Solid lines for dynamics with aneuploidy, where \eumt\ fixates (frequency >99\%) at generation 1,900. Dashed lines for dynamics without aneuploidy ($\delta=0$), where \eumt\ fixates much earlier, at generation 500.
     }
  \label{fig:FA}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
