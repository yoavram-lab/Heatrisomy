...
Inference assuming $\mu=10^{-5}$ or $\mu=10^{-7}$ produced a higher estimate of the aneuploidy rate, $\delta$; assuming $\mu=10^{-7}$, the estimated fitness of \anwt\ was lower; otherwise, estimates were similar to our main model (\Cref{fig:mu}).
