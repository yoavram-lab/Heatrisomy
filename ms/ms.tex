...
Models with $\mu$=$10^{-5}$ and $\mu$=$10^{-7}$ inferred different parameters estimates, including higher aneuploidy rate and the model with $\mu$=$10^{-5}$ has lower fitness value for \anwt\ (\Cref{fig:mu}).
...
$w_{2n^*}=1.053\ [1.051-1.055]$. 
Notably, the maximum posterior ratio $w_{\eumt}/w_{\anwt}=1.0009$ is much lower than the maximum prior ratio of $1.033$ (\Cref{fig:growth-curves}H) and closer to the ratio of $1$ that we assume in our standard prior.
