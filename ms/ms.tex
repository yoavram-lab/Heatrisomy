...
The number of measurement of the frequency of aneuploidy in \textit{S.cervisiae} is limited to three time points (0, \~450 and \~2000). 

The populations had fluctuating populations sizes due to dilution. We use the harmonic mean to determine a single number, on which all of the inference and simulations is based.    

Mathematical model is very simplistic. One mutation of fixed effect, at a single locus that accounts for all the benefit. Haploid model where yest is diploid and the aneuploidy is trisomie. 
