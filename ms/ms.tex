...
\begin{figure}[p]
  ...
  \end{subfigure}
  \caption{
    \textbf{Likelihood profiles.} The different curves show how the single-locus model approximate likelihood, $\likelihood_{!}(\theta)+10^{-2}$, changes when each of the parameter changes while the other parameters remain fixed at their MAP estimates. We add $10^{-2}$ to the likelihood for proper representation in a log scale. Dashed vertical line represents the MAP value.
  }
