...
def plot_kde_matrix2(df, w, limits=None, colorbar=True, height=2.5,
                    numx=50, numy=50, refval=None, refval_color='C1',
                    kde=None, names: dict = None, arr_ax=None):
    """
    Plot a KDE matrix for 1- and 2-dim marginals of the parameter samples.
...
def plot_kde_matrix_for_paper(df, w, limits=None, colorbar=True, height=2.5,
                    numx=50, numy=50, refval=None, refval_color='C1',
                    kde=None, names: dict = None, arr_ax=None):
    """
    Plot a KDE matrix for 1- and 2-dim marginals of the parameter samples.
...
def plot_kde_matrix_for_paper_was(df, w, limits=None, colorbar=True, height=2.5,
                    numx=50, numy=50, refval=None, refval_color='C1',
                    kde=None, names: dict = None, arr_ax=None):
    """
    Plot a KDE matrix for 1- and 2-dim marginals of the parameter samples.
